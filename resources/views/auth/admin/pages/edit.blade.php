                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('UpdateUser' , $user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telephone" type="text" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ $user->telephone }}" required autocomplete="telephone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="gender" type="text" class="form-control @error('gender') is-invalid @enderror" name="gender" value=" {{ $user->gender}} " autocomplete="gender">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="status" type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ $user->status }} autocomplete="status">
